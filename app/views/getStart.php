            ...
            <div class="container">
                <nav class="navbar navbar-light navbar-expand-lg py-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <a href="/login" class="btn btn-primary py-2 px-4 d-none d-xl-inline-block rounded-pill">Log In</a>
                        <a href="/register" class="btn btn-primary py-2 px-4 d-none d-xl-inline-block rounded-pill">Sign Up</a>
                    </div>
                </nav>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <h1 class="display-1 mb-4 animated bounceInDown"> <span class="text-primary">Cater</span>Serv</h1>
                        <a href="/login" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 me-4 animated bounceInLeft">Get Started!</a>
                    </div>
